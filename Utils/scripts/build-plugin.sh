...
opencv_dependencies="-DWITH_VTK=OFF -DWITH_1394=OFF -DWITH_GSTREAMER=OFF -DWITH_V4L=OFF -DWITH_QT=OFF -DWITH_GTK=OFF -DWITH_GPHOTO2=OFF -DWITH_MATLAB=OFF -DWITH_TIFF=OFF -DWITH_JASPER=OFF -DWITH_JPEG=OFF -DWITH_PNG=OFF -DWITH_CUDA=OFF -DWITH_OPENEXR=OFF"
opencv_modules="-DBUILD_opencv_hdf=OFF -DBUILD_OPENCV_JAVA=OFF -DBUILD_OPENCV_WORLD=OFF -DBUILD_OPENCV_PYTHON=OFF -DBUILD_opencv_python2=OFF -DBUILD_opencv_python3=OFF -DBUILD_TESTS=OFF -DBUILD_PERF_TESTS=OFF -DBUILD_opencv_apps=OFF -DBUILD_ANDROID_EXAMPLES=OFF -DBUILD_DOCS=OFF -DBUILD_OPENCV_CONTRIB=OFF -DBUILD_LIST=core,imgproc"
opencv_options="$opencv_dependencies $opencv_modules $opencv_issue -DBUILD_EXAMPLES=OFF -DBUILD_SHARED_LIBS=OFF -DBUILD_WITH_DEBUG_INFO=OFF -Wno-deprecated -DCMAKE_TRY_COMPILE_PLATFORM_VARIABLES=CMAKE_WARN_DEPRECATED"
